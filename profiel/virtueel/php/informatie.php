...
?>
	...
	<nav>
		<ul id="n" class="clearfix">
                    ...
                    <li class="sel"><a href="informatie.php">Informatie</a></li>
	...
	<div id="content" class="clearfix">
        ...
        <section id="informatie_tekst_1">                            
            <div class="gcontent">
                <div class="informatie_head"><h1>Wat is Virtueel Assistent</h1></div>
                    <div class="boxy">
                        <p class="informatie_tekst">
